...
/**
* linked_list_length - it determines length of linked list
...
/**
* findNodeWithPrefixAndChar- returns node whose string starts with prefix
...
/**
* indexOfListNode - gets the index of a node
